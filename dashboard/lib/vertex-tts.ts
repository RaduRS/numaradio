...
/** Generates a Lena-voice MP3 via Gemini 3.1 Flash TTS (Leda).
 *  Mirrors workers/queue-daemon/vertex-tts.ts — the dashboard is a
 *  separate npm package and can't share code directly. */
