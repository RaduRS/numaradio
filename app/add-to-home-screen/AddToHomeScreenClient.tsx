...
// Stable committed asset — a live B2 track ID could get purged by a
// library cleanup and break every phone mockup on the page.
const MOCK_ARTWORK = "/mock-cover.svg";
...
export function AddToHomeScreenClient() {
